           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                        <a class="active-menu" href="{{ url('approved-requests') }}"><i class="fa fa-square-o fa-3x"></i>Set Meeting</a>
                    </li>
                        ...
                        <form action="{{ route('admin.schedule.meeting') }}" method="POST">
                            ...
                            <td>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="Set Meeting" name="meeting_date" id="meeting_date_{{ $request->id }}" class="form-control datetimepicker" required>
                                </div>
                            </td>
                            <td>
